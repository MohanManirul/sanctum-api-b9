            ...
            <form id="apartmentForm" enctype="multipart/form-data" onsubmit="updateApartment(event)">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <img id="imagePreview" src="" alt="Apartment Image" class="mt-2" style="max-width: 150px; display: none;">
                    </div>
...
<script>
    ...
    async function fillApartment() {
        ...
        try {
            let response = await axios.get(`/api/v1/admin/dashboard/apartments/${apartmentId}/edit`, {
                headers: {
            ...
            if(apartment.image){
                preview.src = `/storage/${apartment.image}`;
