        ...
        <div class="card login-card p-4">
            ...
            <form onsubmit="tenantRegistration(event)">
                ...
                <div class="mb-3">
                    ...
                    <input id="name" type="text" class="form-control form-control-lg" placeholder="Mr. Rahman" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Phone</label>
                    <input id="phone" type="text" class="form-control form-control-lg" placeholder="01515....." required>
                </div>
