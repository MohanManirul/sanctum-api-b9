        ...
        <div class="card login-card p-4">
            <div class="text-center mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="PhoneID" class="form-control form-control-lg" placeholder="admin@example.com">
                </div>
...
<script>
    ...
    async function tenantLogin(){
        ...
        console.log(obj);
        try{
            let URL = '/api/v1/tenant/login';
            
            let response = await axios.post(URL, obj);
            // Store token in localStorage
            console.log(response);
            localStorage.setItem('tenant_token', response.data['access_token']);
